    ...
    private static final class AsyncRendererBuilder
        ...
        private void buildRenderers() {
            ...
            ChunkSource videoChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    elapsedRealtimeOffset, mainHandler, player, com.example.pietrogirardi.piplayer.Player.TYPE_VIDEO);
            ChunkSampleSource videoSampleSource = new ChunkSampleSource(videoChunkSource, loadControl,
                    VIDEO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    com.example.pietrogirardi.piplayer.Player.TYPE_VIDEO);
            ...
            ChunkSource audioChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    elapsedRealtimeOffset, mainHandler, player, com.example.pietrogirardi.piplayer.Player.TYPE_AUDIO);
            ChunkSampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource, loadControl,
                    AUDIO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    com.example.pietrogirardi.piplayer.Player.TYPE_AUDIO);
            ...
            ChunkSource textChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    elapsedRealtimeOffset, mainHandler, player, com.example.pietrogirardi.piplayer.Player.TYPE_TEXT);
            ChunkSampleSource textSampleSource = new ChunkSampleSource(textChunkSource, loadControl,
                    TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    com.example.pietrogirardi.piplayer.Player.TYPE_TEXT);
            TrackRenderer textRenderer = new TextTrackRenderer(textSampleSource, player,
                    mainHandler.getLooper());

            // Invoke the callback.
            TrackRenderer[] renderers = new TrackRenderer[com.example.pietrogirardi.piplayer.Player.RENDERER_COUNT];
            renderers[com.example.pietrogirardi.piplayer.Player.TYPE_VIDEO] = videoRenderer;
            renderers[com.example.pietrogirardi.piplayer.Player.TYPE_AUDIO] = audioRenderer;
            renderers[com.example.pietrogirardi.piplayer.Player.TYPE_TEXT] = textRenderer;
